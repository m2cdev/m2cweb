...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-white/10 pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-full h-[500px] bg-[radial-gradient(circle_at_bottom_left,_rgba(98,210,162,0.07)_0%,_transparent_50%)] pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-full h-[500px] bg-[radial-gradient(circle_at_bottom_right,_rgba(249,107,107,0.07)_0%,_transparent_50%)] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:ml-auto">
            ...
            <ul className="space-y-4">
              <li><Link href="/" className="text-gray-400 hover:text-[#62D2A2] transition-colors font-body text-sm">Home</Link></li>
              <li><Link href="/who-we-are" className="text-gray-400 hover:text-[#62D2A2] transition-colors font-body text-sm">Who We Are</Link></li>
              <li><Link href="/who-we-are/compare" className="text-gray-400 hover:text-[#62D2A2] transition-colors font-body text-sm">How We Compare</Link></li>
              <li><Link href="/case-studies" className="text-gray-400 hover:text-[#62D2A2] transition-colors font-body text-sm">Case Studies</Link></li>
            </ul>
          </div>
          ...
          <div className="md:ml-auto">
            ...
            <address className="not-italic text-gray-400 font-body space-y-2 text-sm">
          ...
          <div className="md:ml-auto">
            ...
            <ul className="space-y-4">
              <li>
                <a href="tel:+19292983580" className="text-gray-400 hover:text-[#62D2A2] transition-colors font-body text-sm">
                  (929) 298-3580
                </a>
              </li>
              <li>
                <a href="mailto:letsclose@map2close.com" className="text-gray-400 hover:text-[#62D2A2] transition-colors font-body text-sm">
