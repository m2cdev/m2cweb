      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                ...
                <div
                  className="h-4 w-4 rounded-full bg-[#62D2A2] border border-[#62D2A2]/50 p-2" />
              </div>
              <h3
        ...
        <div
          ...
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-[#62D2A2] via-[#F96B6B] to-transparent from-[0%] via-[30%] rounded-full" />
        </div>
      </div>
    </div>
  );
