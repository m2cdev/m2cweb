...
const caseStudies = {
  pinecone: {
    ...
    problem: [
      "Our client sells a technical, high-stakes product into engineering-heavy organizations building on top of AI. The barrier to entry is real. The sales cycle is long. And the competitive landscape is ruthless.",
      "The problem was not the product. It was not the reps. It was that the right content never made it into the right conversation at the right time. Assets existed: battlecards, one-pagers, objection guides. But they were scattered, outdated, and impossible to surface quickly during an active deal.",
      "Against well-resourced competitors, showing up underprepared is not just inefficient. It is expensive.",
    ],
    build: [
      "We built a centralized Sales Enablement Hub: a live, AI-enabled content repository where reps could filter assets by deal stage, buyer persona, and use case in real time. Battlecards organized by competitors. Technical one-pagers tailored to engineering stakeholders versus business buyers. Objection handling built around this team's most common friction points.",
    ],
    ...
    outcomes: [
      ...
      "Sharper competitive messaging against established market leaders",
    ],
  },
  signpost: {
    ...
    resultTitle: "Projected ROI and Impact",
    problem: [
      "This client helps small and mid-sized service businesses handle inbound communication so they never miss a lead. Strong product. Real market need.",
    ...
    build: [
      "We built a custom Signal Intelligence Engine that scraped and analyzed public review data across tens of thousands of target businesses nationwide. The engine scanned for communication failure signals - missed calls, slow response complaints, front-desk issues - and scored every account across four dimensions: Fit, Demand, Comms Pain, and Growth.",
      "High-scoring accounts were automatically enriched, de-duplicated, and pushed directly into the client's HubSpot - each one tagged with a short rep-facing brief explaining exactly why they were surfaced and what angle to lead with on the call.",
      "Reps went from spending 10 to 20 minutes researching each account to zero. The engine did it for them.",
    ],
    ...
    outcomes: [
      "1,500 to 6,000 ICP-fit leads generated per month",
      "+10 to 25% improvement in DM connect rate",
      "+15 to 30% increase in demo set rate",
  ...
  qwilr: {
    ...
    resultTitle: "Projected ROI and Impact",
    problem: [
      "This organisation sells a proposal and document platform that helps B2B sales teams replace static PDFs with interactive, trackable proposals. The product sells itself in the demo. Intuitive, visual, and easy to show value fast.",
      "The problem was not top of funnel. It was not demo quality. It was what happened after.",
    ...
    build: [
      "We designed and implemented a Trial-to-Close Engine: a structured system that turned the client's open-ended trial period into a guided, high-accountability decision experience.",
    ...
    impact: "Deals that used to drift post-demo now had structure, ownership, and momentum. Reps knew exactly what to do and when. Leadership could finally see where deals were moving and where they were not.",
    outcomes: [
...
const nextStudyMap = {
  pinecone: ["signpost", "qwilr"],
  signpost: ["pinecone", "qwilr"],
  qwilr: ["pinecone", "signpost"],
};
...
function LoomEmbed({ loomId, thumbnail }) {
  ...
  return (
    <div className="relative w-full aspect-video rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-black">
      {!isPlaying ? (
        <div
          className={`absolute inset-0 z-10 flex flex-col items-center justify-center group/overlay ${loomId ? "cursor-pointer" : ""}`}
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden border-b border-white/[0.06]">
        ...
        <div className="container mx-auto px-6 md:px-16 relative z-10 grid md:grid-cols-2 gap-8 md:gap-16 items-center py-20 pt-32 md:py-32 md:pt-40">
          ...
          >
            ...
            <h1 className="text-4xl md:text-8xl font-black tracking-tighter leading-[0.9] mb-8">
              {study.title}
            </h1>
