    ...
    <div className="flex flex-col w-full bg-[#050505] min-h-screen">
      ...
      <BackgroundPaths>
        <div className="container-custom pt-40 pb-20">
          <div className="max-w-5xl mb-16">
            ...
            >
              For <span className="text-red-500">Sales</span> People,<br />From <span className="text-[#62D2A2]">Sales</span> People
            </motion.h1>
            <motion.div 
            ...
            >
              <p className="text-xl md:text-2xl text-white opacity-80 font-body leading-relaxed">
                <span className="font-bold text-white">Map2Close is a sales enablement partner for B2B teams.</span><br />
                We do not just provide strategy. We embed inside your sales motion to build systems and help reps execute them.
              </p>
              <p className="text-lg md:text-xl text-white opacity-60 font-body leading-relaxed">
                With 20+ years of experience in B2B sales across Tech, Retail, Finance, and more, we saw the same problem everywhere: generic software built for the masses, consultants pushing one-size-fits-all playbooks, and real sales problems never actually getting solved.
              </p>
              <p className="text-2xl md:text-3xl font-black tracking-tight text-white mt-2">
      ...
      <div className="container-custom py-32">
        <div className="flex flex-col items-center justify-center mb-16 text-center">
          <h2 className="text-[#62D2A2] font-heading font-medium text-[16px] tracking-[0.15em] uppercase mb-4">
            Our Partners
          </h2>
        </div>
        <div className="flex flex-col md:flex-row items-center justify-center gap-16 md:gap-32">
          ...
          >
            <div className="text-white group-hover:text-[#FF5B2D] transition-colors duration-300 mb-4">
            ...
            <p className="font-heading font-black text-[10px] tracking-[0.2em] uppercase text-white group-hover:text-[#FF5B2D] transition-colors duration-300">Integration Partner</p>
          </a>
          ...
          >
            <div className="text-white group-hover:text-[#8B5CF6] transition-colors duration-300 mb-4">
            ...
            <p className="font-heading font-black text-[10px] tracking-[0.2em] uppercase text-white group-hover:text-[#8B5CF6] transition-colors duration-300">Data Partner</p>
          </a>
        </div>
      </div>
